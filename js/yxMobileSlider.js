(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="focus"><p></p><div></div></div>');
            ...
            $(window).bind('resize load', function(){
                ...
                $("p", oFocusContainer).width(_this.width()-oFocus.outerWidth(true) * num-15).css({
                    height: _this.height() * 0.15,
                    lineHeight: _this.height() * 0.15+'px'
                });
                _this.fadeIn(300);
                doChangeTitle();
            });
            ...
            function doChangeTitle(){
                var textTitle=oLi.eq(iCurr).attr('data-title');
                oFocusContainer.find('p').html(textTitle?textTitle:'');
            }
            //绑定触摸事件
